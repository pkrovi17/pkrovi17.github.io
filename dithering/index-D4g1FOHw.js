...
void main() {
  ...
  if (e == 1.0) {
    ...
    vec3 thresholdColor = modeA > 0.5 ? mix(colorB, colorA, q) : vec3(q);
    ...
    float glyphSeed = hash(grid + floor(time * speed * 4.0));
